...
namespace Assets.Scripts.Visuals
{
    ...
    public class LineRotatorY : MonoBehaviour
    {
        // Dependencies
        ...
        private Quaternion OneEightyRotation = Quaternion.Euler(0, 270, 180);
        private Quaternion TwoSeventyRotation = Quaternion.Euler(180, 270, 180);
