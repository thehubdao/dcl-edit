...
public class OutlineCombineFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    OutlineCombineRenderPass myRenderPass;

    public override void Create()
    {
        myRenderPass = new OutlineCombineRenderPass(
            "Outline Combine Pass",
