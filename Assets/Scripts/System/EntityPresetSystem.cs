...
namespace Assets.Scripts.System
{
    ...
    {
        private struct EntityPreset
        {
            public string name;
            public DclEntity templateEntity;
        }
        ...
        public IEnumerable<AvailablePreset> availablePresets => entityPresets.Select(preset => new AvailablePreset {index = preset.Key, name = preset.Value.name});
